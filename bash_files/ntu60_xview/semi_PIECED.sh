...
# [수정] 평가할 체크포인트 경로
CKPT_PATH="exp/ntu60_xview/SA/2026_01_04_06_05_40-PIECED/owrpcajv/PIECED-task4-ep=499-owrpcajv.ckpt"
# exp/ntu60_xview/SA/2026_01_02_09_00_33-FT/lbjqw4e0/FT-task0-ep=499-lbjqw4e0.ckpt
# exp/ntu60_xview/SA/2026_01_04_06_05_40-PIECED/auo971xf/PIECED-task1-ep=499-auo971xf.ckpt
# exp/ntu60_xview/SA/2026_01_04_06_05_40-PIECED/rw5m5uh5/PIECED-task2-ep=499-rw5m5uh5.ckpt
# exp/ntu60_xview/SA/2026_01_04_06_05_40-PIECED/edj75yi8/PIECED-task3-ep=499-edj75yi8.ckpt
# exp/ntu60_xview/SA/2026_01_04_06_05_40-PIECED/owrpcajv/PIECED-task4-ep=499-owrpcajv.ckpt

# [수정] 데이터셋 경로
DATA_DIR="${DATA_DIR:-./data/ntu60/xview}"

# [수정] WandB 프로젝트 및 기본 Job 이름
# (나중에 뒤에 _1p, _10p가 붙습니다)
BASE_PROJECT_NAME="semi_ntu60_xview"
BASE_JOB_NAME="PIECED"
...
FINAL_JOB_NAME="${BASE_JOB_NAME}_${SUFFIX}"
FINAL_PROJECT_NAME="${BASE_PROJECT_NAME}"
